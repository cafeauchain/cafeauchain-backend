...
# api_v1_admin_roaster_profile_update_inventory_item_quantities PUT    /api/v1/admin/roasters/:roaster_profile_id/update_inventory_item_quantities(.:format)    api/v1/admin/roaster_profiles#update_inventory_item_quantities
#                       api_v1_admin_roaster_profile_delete_lot PUT    /api/v1/admin/roasters/:roaster_profile_id/delete_lot(.:format)                          api/v1/admin/roaster_profiles#delete_lot
